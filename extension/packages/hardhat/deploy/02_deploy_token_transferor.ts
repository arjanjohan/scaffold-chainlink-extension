 ...
 */
const deployTokenTransferor: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
...
export default deployTokenTransferor;

deployTokenTransferor.tags = ["TokenTransferor"];
