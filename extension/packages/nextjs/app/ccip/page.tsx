  ...
  return (
    <div className="min-h-screen max-w-[1200px] mx-auto flex flex-col items-center justify-center">
      ...
      <div className="container text-center w-full mt-16">
        <h1 className="text-3xl sm:text-6xl font-bold">Scaffold-ETH Chainlink CCIP Extension</h1>
      </div>
      ...
      <section id="overview" className="container mx-auto text-center py-20">
        ...
        <div className="space-x-4">
          <a href="https://github.com/your-repo-link" className="btn btn-primary text-white px-6 py-3 rounded shadow">
            View on GitHub
          </a>
